...
describe("generatePayload", () => {
  it("creates a payload based on standard options", () => {
    ...
    expect(result.cloudEventsVersion).toEqual("0.2");
    ...
    expect(result.eventType).toEqual("com.github.cds-snc.foo");
...
describe("error", () => {
  it("creates a error level event and sends it to console log", () => {
    ...
    expect(result.eventType).toEqual("com.github.cds-snc.error");
  });
